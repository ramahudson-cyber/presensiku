...
export default function EmployeeDashboard() {
  ...
  if (loading) {
    return (
      <div className="space-y-3">
        <div className="bg-violet-400/20 backdrop-blur-sm border border-white/10 rounded-2xl p-5 h-20 animate-pulse"></div>
        <div className="bg-violet-400/20 backdrop-blur-sm border border-white/10 rounded-2xl p-4 h-16 animate-pulse"></div>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">{[1,2,3,4].map(i => <div key={i} className="bg-violet-400/20 backdrop-blur-sm border border-white/10 rounded-xl p-3 h-16 animate-pulse"></div>)}</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-3 animate-fade-in">
      ...
      <div className="bg-violet-400/20 backdrop-blur-md border border-white/10 rounded-2xl p-5 shadow-lg shadow-violet-900/10">
      ...
      <Link to="/employee/attendance" className="block">
        <div className="bg-violet-400/20 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-lg shadow-violet-900/10 flex items-center justify-between hover:bg-white/[0.06] transition">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          {[
            ...
            <div key={s.label} className="bg-violet-400/20 backdrop-blur-md border border-white/10 rounded-xl p-3 text-center shadow-lg shadow-violet-900/10">
      ...
      <div>
        ...
        <div className="bg-violet-400/20 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-lg shadow-violet-900/10">
