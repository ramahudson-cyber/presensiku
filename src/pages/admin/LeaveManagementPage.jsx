  ...
  return (
    ...
    >
      ...
      <section id="stats" aria-label="Status overview" style={{ marginBottom: 36 }}>
        <div className="leave-stats" style={{ display: "grid", gridTemplateColumns: "repeat(4,minmax(0,1fr))", gap: "14px" }}>
          <article
            style={{ padding: "32px 26px", background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 20, boxShadow: "0 4px 16px rgba(15,23,42,0.06)", transition: "all .4s cubic-bezier(0.32,0.72,0,1)" }}
      ...
      <div id="workbench" className="leave-workbench" style={{ display: "grid", gridTemplateColumns: "minmax(0,1.7fr) minmax(300px,480px)", gap: 32, alignItems: "start" }}>
      ...
      <style>{`
        ...
        @media(max-width:1100px){
          .leave-stats{grid-template-columns:repeat(2,minmax(0,1fr))!important;}
          .leave-workbench{grid-template-columns:minmax(0,1fr)!important;}
        }
        @media(max-width:640px){
          .leave-stats{grid-template-columns:minmax(0,1fr)!important;}
        }
      `}</style>
    </div>
  );
