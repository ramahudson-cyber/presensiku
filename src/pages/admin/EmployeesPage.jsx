    ...
    <div className="space-y-5 animate-fade-in pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2.5 px-4 py-3 bg-electric-violet text-pure-white rounded-full text-sm font-medium hover:brightness-110 active:brightness-90 transition-all duration-200 w-full sm:w-auto"
        >
          <UserPlus size={16} />
          Tambah Pegawai
        </button>
