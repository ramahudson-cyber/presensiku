    ...
    >
      <div className="flex items-center justify-between h-[72px] md:h-20 px-4 md:px-10">
        ...
        <div className="flex items-center gap-3 min-w-0 flex-1">
          <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-electric-violet to-deep-indigo flex items-center justify-center text-pure-white text-xs font-bold shadow-lg shrink-0">
